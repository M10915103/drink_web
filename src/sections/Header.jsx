...
export default function Header(){
 ...
 return <header className="site-header" ref={root}>
  ...
  <nav className="main-nav" aria-label="Main navigation"><a href="#" className="brand" aria-label="MANA home"><img src="/assets/mana-logo.svg" alt="MANA"/></a><div className="nav-links">
