    ...
    <section className="c-HomeHero--part1 r">
      <div className="innerCercle f lotties">
        ...
        <div className="step step1 flex flexJCe a">
          <div className="stepChild h100 r flex">
            <img className="a fond" src={assetUrl('fond2.png')} />
            <div className="gauche r">
              <Lottie className="lottie_hibi_1 a" file="lottie_hibi_1.json">
                <img className="a star" src={assetUrl('home_star.svg')} />
              </Lottie>
            ...
            <div className="droite r">
              <Lottie className="lottie_hibi_3 a" file="lottie_hibi_3.json">
                <img className="a planet" src={assetUrl('home_planet.svg')} />
                <img className="a star" src={assetUrl('home_star.svg')} />
              </Lottie>
            </div>
          </div>
        ...
        <div className="step step2 flex flexJCe a">
          <div className="stepChild h100 r flex">
            <img className="a fond" src={assetUrl('fond3.png')} />
            <div className="gauche r">
              <Lottie className="lottie_trop_1 a" file="lottie_trop_1.json">
                <img className="a eau" src={assetUrl('home_eau.svg')} />
              </Lottie>
              <img src={assetUrl('mangue.svg')} className="mangue a" />
            </div>
            <div className="droite r">
        ...
        <div className="step step3 flex flexJCe a">
          <div className="stepChild h100 r flex">
            <img className="a fond first" src={assetUrl('fond4.png')} />
            <div className="gauche r">
              <div className="introGauche a">
                <img className="a fleur" src={assetUrl('home_fleur.svg')} />
        ...
        <div className="step step7 flex flexJCe a">
          <div className="stepChild h100 r flex">
            <img className="a fond" src={assetUrl('fond4.png')} />
            <div className="gauche r">
              <img className="a fleur" src={assetUrl('home_fleur.svg')} />
              <Lottie className="lottie_melo_1 a" file="lottie_melo_1.json" />
            </div>
        ...
        <div className="flex r flexSb flexCe">
          <button className="btnRond r heroPrev bounce" onClick={() => onChange(-1)} aria-label="Previous flavor">
            <span className="elBounce flex flexCe flexJCe">
              <img src={assetUrl('i_arrow.svg')} />
            </span>
          </button>
          <div className="innerBtn">
            <a href="#products" className={"btn btnOmbre r" + (flavor === 0 ? ' current' : '')}>
            ...
            <a href="#products" className={"btn btnOmbre r btnOmbreBleu" + (flavor === 1 ? ' current' : '')}>
            ...
            <a href="#products" className={"btn btnOmbre r btnOmbreRouge" + (flavor === 2 ? ' current' : '')}>
            ...
            <a href="#products" className={"btn btnOmbre r btnOmbreVert" + (flavor === 3 ? ' current' : '')}>
          ...
          <button className="btnRond r heroNext bounce" onClick={() => onChange(1)} aria-label="Next flavor">
            <span className="elBounce flex flexCe flexJCe">
              <img className="rotate" src={assetUrl('i_arrow.svg')} />
            </span>
          </button>
        </div>
      </div>
